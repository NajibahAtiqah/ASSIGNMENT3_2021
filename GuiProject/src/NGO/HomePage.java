...
public class HomePage extends JFrame {
	...
	public HomePage() {
		...
		LogoLabel.setIcon(new ImageIcon("C:\\Users\\lenovo\\Downloads\\Cahaya cancer association.png"));
		...
		panel_3.add(Staff);
		Staff.setIcon(new ImageIcon("C:\\Users\\lenovo\\Desktop\\img\\Patients-icon.png"));
		...
		CashLabel.setIcon(new ImageIcon("C:\\Users\\lenovo\\Desktop\\img\\Money-icon.png"));
		...
		lblNewLabel_1.setIcon(new ImageIcon("C:\\Users\\lenovo\\Desktop\\img\\users-icon.png"));
		
		JLabel lblNewLabel = new JLabel("");
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\lenovo\\Desktop\\img\\download.jpg"));
		lblNewLabel.setBounds(178, 11, 211, 182);
		panel.add(lblNewLabel);
		
		JLabel lblNewLabel_2 = new JLabel("");
		lblNewLabel_2.setIcon(new ImageIcon("C:\\Users\\lenovo\\Desktop\\img\\download (1).jpg"));
		lblNewLabel_2.setBounds(387, 11, 164, 171);
		panel.add(lblNewLabel_2);
		
		JLabel lblNewLabel_3 = new JLabel("");
		lblNewLabel_3.setIcon(new ImageIcon("C:\\Users\\lenovo\\Desktop\\img\\hp.jpg"));
		lblNewLabel_3.setBounds(550, 11, 184, 171);
		panel.add(lblNewLabel_3);
		
		JLabel lblNewLabel_4 = new JLabel("");
		lblNewLabel_4.setIcon(new ImageIcon("C:\\Users\\lenovo\\Desktop\\img\\images (1).jpg"));
