...
public class Finance extends JFrame {
	...
	public Finance() {
		...
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\lenovo\\Desktop\\img\\coins-icon.png"));
		...
		UploadButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					File file = new File("C:\\Users\\lenovo\\Desktop\\CahayaCancerAssociation\\FinancialStatement.txt");
					if (!file.exists()) {
						file.createNewFile();
					}
